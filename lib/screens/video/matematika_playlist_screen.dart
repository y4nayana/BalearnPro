...
class MatematikaPlaylistScreen extends StatelessWidget {
  final Map<String, dynamic> playlist;

  MatematikaPlaylistScreen({required this.playlist});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(playlist["title"]), // Perbaikan key untuk title
      ...
      body: playlist["videos"].isEmpty
          ? Center(child: Text("Tidak ada video untuk playlist ini."))
          : Padding(
